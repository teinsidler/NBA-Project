...
tonight_df = playing_tonight(questionable = True, json_path = "data/dk_salaries/dk_json/2021_2022")
...
output_df.to_csv(f"data/projections/2021_2022/projections_{game_day}.csv", index = False)
